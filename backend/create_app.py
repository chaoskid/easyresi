...
def createApp(config_class=Config):
    ...
    CORS(app, supports_credentials=True, origins=['http://localhost:3000', 'http://localhost:5002'], resources={r"/api/*": {"origins": "http://localhost:3000"}, r"/auth/*": {"origins": "http://localhost:3000"}})
