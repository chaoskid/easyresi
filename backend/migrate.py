...
def load_data(engine):
    ...
    unicourse_df.to_sql('unicourse', con=engine, if_exists='append', index=False)

    # Insert data into cost_of_living table
    cost_of_living_df.to_sql('cost_of_living', con=engine, if_exists='append', index=False)

    # Insert data into occupation_shortage table
    occupation_shortage_df.to_sql('occupation_shortage', con=engine, if_exists='append', index=False)
